...
module.exports = {
    ...
    save: async (tree) => {
        ...
        /*
            config.localRender===ture: Render the static html report
            config.localRender===ture && config.localAutoRender===ture: Open local browser render the current static html report 
        */
