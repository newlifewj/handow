...
module.exports = async (customStepsPath) => {
    ...
    let _steps = await stepSnippets( path.join(config._rootPath, 'lib/steps/acts.step.js') );
    ...
    _steps = await stepSnippets(  path.join(config._rootPath, 'lib/steps/facts.step.js')  );
