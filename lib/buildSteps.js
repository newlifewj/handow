...
module.exports = async (customStepsPath) => {
    try {
        ...
        const _actSnippets = _steps["acts"];
        ...
        const _factSnippets = _steps["facts"];
        ...
        if ( customPath ) {
            ...
            for ( const file of stepFiles ) {
                ...
                deepExtend( _actSnippets, _steps["acts"] );
                deepExtend( _factSnippets, _steps["facts"] );
                _variables = _variables.concat(_steps["variables"]);
            }
        }
        ...
        /*
            Generate stepLabels.json for IDE suggestion
        */
        const stepLabels = { acts: Object.keys(_actSnippets), facts: Object.keys(_factSnippets) };
