...
module.exports = {
    ...
    cliHelp: () => {
        // u+0009, Tab unicode
        tmnl("Handow CLI (with npx runner):\u0009").brightCyan("& ")("npx handow --[task] [target-path]\n\n");
        tmnl("--[task]\u0009\u0009\u0009").green("--plan\u0009\u0009")("Run specific plan, followed by a plan path\n");
        tmnl("\u0009\u0009\u0009\u0009").green("--story\u0009\u0009")("Run specific story or stories, followed by stories directory or '.feature' story path\n");
        ...
        tmnl("Examples:\u0009\u0009\u0009").brightCyan("[root-path]/$ ").green("npx handow --plan /project/testPlan\n");
        tmnl("\u0009\u0009\u0009\u0009").brightCyan("[root-path]/$ ").green("handow --buildstep\n");

    },

    cliStarting: () => {
        tmnl.brightGreen("Handow start running ...\n");
    },
