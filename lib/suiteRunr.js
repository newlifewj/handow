 ...
 * @param {object} planBrowser Browser instance the plan use plan scope browser, or null|undefined for story scoped browser session
 * @return {Promise} Records are updated and output to console along with story running, but no data is returned.
 */
module.exports = async ( suite, stageParams, planBrowser ) => {
    ...
    */
    ...
    if (!planBrowser) {
        ...
        // Thinking: Use default context or new incogniti context?
    ...
    */
    await pageManager.close(browser, page, Boolean(planBrowser));    
