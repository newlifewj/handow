...
module.exports = {
    ...
    // Dedault using headless browsers, set it to false for local watching the browser render
    headless: true,

    // Handle a probe when process parameter selector, default is false, 
    htmlProbe: "h4w",

    // The testing browser, ""chromium" | "firefox" | "webkit", default is "chromium"
    browser: "chromium",
    ...
    // newIncognitoContext: false,      // Just follow the 'browserSessionScope' field, using Incognito Context if the browser session scope is NOT 'plan'
    ...
    // The API library of Playwright for current running, "chromium" | "firefox" | "webkit"
    pwtAPI: "chromium",
    ...
    // Behavior on "no step in lib" ... those running exceptions.
