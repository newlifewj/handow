 ...
 * @Note - The xhr will be recorded to other following pages the XHR response is not finished in this step ...
 */
...
/**
 * The step to stop handow engine, only for local debug usage
 */
