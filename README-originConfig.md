...
The _/lib/\_config.json_ is the origin configuration of **handow-core** or the Handow project (**handow-core** + **handow-shm**). The properties could be overridden by the Handow API caller or test running envirionment.
